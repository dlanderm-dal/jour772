#David Landerman Data Journalism Project 9.10.25---
title: "lab_01"
...
#hypothetically two different tables one pivot table for instructor instances, and one for department
**A3**

```{r}
umd_courses %>% 
  group_by(str_split(instructors,"; ", n=Inf)) |>
  summarise(
    classes_professors_teach=n()
  )|>
arrange(desc(classes_professors_teach))
```
