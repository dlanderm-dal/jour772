...
```
#ATTN ROB: What did I do wrong? To double check I divided the total salary of males by the sample size, that number checked out but the same didnt work for the females 63198034/1025=61,656.6185365854
...
#Rob I genuinely do not understand what this question is asking. Good faith objection. Are you saying you want me to go back and filter the salaries by 500 instead of 1000? Or does the 500 somehow refer to the number of rows? What do you mean cut with?
...
```
#TY Stackoverflow https://stackoverflow.com/questions/4935479/how-to-combine-multiple-conditions-to-subset-a-data-frame-using-or
...
#A senior reporter from propublica #worthit
...
Editorial director at Conde Naste. I save my resentment for beneficiaries of the carried interest loophole  and executives of companies in defense, insurance , and asset management
